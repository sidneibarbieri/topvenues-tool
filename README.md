...
```bash
git clone --depth 1 --branch v1.5.4 https://github.com/sidneibarbieri/topvenues-tool.git
cd topvenues-tool
...
python -m src.cli --profile security-20-v4 export-hf --release-tag v1.5.4
